...
public class PacienteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PacienteCompletoResponse> buscarPorId(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PacienteResponse> alterar(@PathVariable String id, @RequestBody PacienteRequest request) {
